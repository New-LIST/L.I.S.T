...
public interface ICourseTaskSetRelService
{
    ...
    Task<CourseTaskSetRelDto> CreateAsync(CourseTaskSetRelDto dto, string userId);
    Task<CourseTaskSetRelDto?> UpdateAsync(int id, CourseTaskSetRelDto dto, string userId);

...
{
    /// <inheritdoc />
    public partial class AddAssistantCoursePermissions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "assistant_course_permissions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    assistant_user_id = table.Column<int>(type: "integer", nullable: false),
                    course_id = table.Column<int>(type: "integer", nullable: false),
                    can_view_course_content = table.Column<bool>(type: "boolean", nullable: false),
                    can_manage_course_content = table.Column<bool>(type: "boolean", nullable: false),
                    can_grade_course = table.Column<bool>(type: "boolean", nullable: false),
                    can_run_plagiarism_check = table.Column<bool>(type: "boolean", nullable: false),
                    created = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assistant_course_permissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_assistant_course_permissions_Users_assistant_user_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assistant_course_permissions_assistant_user_id_course_id",
                table: "assistant_course_permissions",
                columns: new[] { "assistant_user_id", "course_id" },
                unique: true);
        }
